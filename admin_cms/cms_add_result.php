    ...
    <div class="has-text-centered master_site_width container columns" id="my_upload_result_form">
        <div class="column is-8 is-offset-2">
            <div class="mt-5 p-5 my_info_colour">
                <div class='my_inline_divs my_info_colour mt-3'>
                    <a href="cms_ref_club_seas.php"><button class="button is-rounded is-danger my_info_colour my-3">Add Referee, Club or Season</button></a>
                </div>
            </div>
