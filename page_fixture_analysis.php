    ...
    <?php
        if (isset($_GET['ht_selector']) && isset($_GET['at_selector']) 
            ...
            if (isset($_GET['strict'])) {
                ...
                if ($nonStrictMode) {
                    $fixtureAPIurl = "http://tkilpatrick01.lampt.eeecs.qub.ac.uk/a_assignment_code/api/?full_matches&fixture={$finalHomeTeamurl}~{$finalAwayTeamurl}";
                    $strictPara = "Data includes reverse fixture";
                } 
            } else {
                $fixtureAPIurl = "http://tkilpatrick01.lampt.eeecs.qub.ac.uk/a_assignment_code/api/?full_matches&fixture={$finalHomeTeamurl}~{$finalAwayTeamurl}&strict";
